...
const Card: React.FC<CardProps> = ({ card, isFlipped }) => {
  ...
  return (
    <div className="w-full max-w-sm h-96 sm:h-[480px] perspective">
      ...
      >
        {/* Card Back */}
        <div className="absolute w-full h-full backface-hidden bg-gray-800 rounded-2xl overflow-hidden border-4 border-yellow-500">
            <CardBackIcon className="w-full h-full" />
        </div>
